    ...
    public static class SimpleGroupViewHolder extends GroupViewHolder
    {
        ...
        public void expand() {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                  expandedIndicator.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_remove_black_24dp));
        ...
        public void collapse() {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    expandedIndicator.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_add_black_24dp));
                    //       ViewHelper.setRotation(expandedIndicator, 180 * (float) (animation.getAnimatedValue()));
                    expandedIndicator.postInvalidate();
                }
            });
