...
public class VarientsByCategory implements Parcelable {
    ...
    public static final Parcelable.Creator<VarientsByCategory> CREATOR = new Parcelable.Creator<VarientsByCategory>() {
        @Override
        public VarientsByCategory createFromParcel(Parcel source) {
            return new VarientsByCategory(source);
        }
